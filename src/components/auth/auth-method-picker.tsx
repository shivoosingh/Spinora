...
export type AuthMethod = "phone" | "whatsapp" | "gmail";
    ...
    <div className="grid grid-cols-3 gap-2 p-1 rounded-xl bg-white/5 border border-white/10">
      {METHODS.map((method) => (
        <button
          ...
          className={cn(
            "flex flex-col sm:flex-row items-center justify-center gap-1 sm:gap-2 rounded-lg py-2.5 px-2 text-xs sm:text-sm font-medium transition-all",
            value === method.id
              ? method.id === "whatsapp"
