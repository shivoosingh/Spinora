...
const url = process.env.GAMEROOM_ADMIN_URL ?? "https://agentserver1.gameroom777.com/admin/login";
const base = url.replace(/\/login.*$/i, "");
const cdpUrl = process.env.GAMEROOM_CDP_URL?.trim() || "http://127.0.0.1:9225";
