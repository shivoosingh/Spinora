...
echo     [x] https://agentserver.mrallinone777.com/admin is LOGGED IN (User Management open)
echo.
echo ============================================================
echo.
...
if errorlevel 1 (
  echo  ERROR: Bot Chrome is not running on port 9227.
...
echo  Chrome detected on port 9227. Starting bot...
echo.
call npm start
